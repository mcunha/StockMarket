...
public class PlayerStocks {
	...
	protected DecimalFormat priceFormatter = new DecimalFormat("#.##");
				...
				try {
					...
					while (result.next()) {
						...
						if(amount_selling > 0){
							...
							System.out.println("[STOCK DEBUG] Selling total " + amount_selling + " - ID: " + result.getInt("id") + " Price Diff " + priceFormatter.format(result.getDouble("price_diff")) + " Qty Diff " + result.getInt("qty_diff") + " sold this round: " + sold_this_round);
